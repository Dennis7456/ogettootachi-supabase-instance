-- Update the create_user_invitation function to use the 'sent' status
-- This migration updates the existing function to set status to 'sent' when creating invitations
...
BEGIN
  ...
  -- Create invitation with 'sent' status
