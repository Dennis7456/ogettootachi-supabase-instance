-- Fix accept_user_invitation function to remove non-existent updated_at column
-- This migration removes references to updated_at column that doesn't exist in user_invitations table
...
BEGIN
  ...
  IF FOUND THEN
    ...
    -- Mark invitation as accepted (removed updated_at reference)
