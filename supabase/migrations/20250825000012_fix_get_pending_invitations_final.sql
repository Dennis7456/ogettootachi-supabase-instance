-- Fix get_pending_invitations function to work with actual table structure
-- This migration ensures the function returns only columns that exist in the user_invitations table
