  ...
  switch (intent) {
    case 'info':
      if (documents.length > 0) {
        ...
        return `Here's what I found from our internal resources: \n${docSummary}\n\nWould you like to schedule a consultation or send a message to our staff?`} else {
    ...
    default: return "I'm here to help! What would you like to know about our services?"}}
